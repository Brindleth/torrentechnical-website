  ...
  return (
    <footer className="relative border-t border-line-dark/60 bg-navy">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 py-16 md:px-10">
        <div className="grid gap-12 md:grid-cols-[1.5fr_1fr_1fr]">
          <div>
            ...
            <p className="max-w-sm text-sm leading-relaxed text-white/55">
              Technical consultancy for Australian industry. Engineering,
              construction, electrical &amp; power, automation, defence and
              industrial trades.
            </p>
          </div>
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t border-line-dark/60 pt-6 font-mono text-[0.65rem] uppercase tracking-[0.18em] text-white/35 md:flex-row md:items-center">
